...
describe "Mods <relatedItem> Element" do
  before(:all) do
    @rel_it1 = mods_record("<relatedItem displayLabel='Bibliography' type='host'>
                        <titleInfo>
                            <title/>
                        </titleInfo>
                        <recordInfo>
    ...
    @rel_it_mult = mods_record("<relatedItem>
                        <titleInfo>
    ...
    @rel_it2 = mods_record("<relatedItem type='constituent' ID='MODSMD_ARTICLE1'>
                        <titleInfo>
    ...
    @coll_ex = mods_record("<relatedItem type='host'>
                        <titleInfo>
